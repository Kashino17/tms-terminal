...
## Aktive Arbeit
- **feat/chrome-remote-control Branch:** Voice Mode UX Polish (v1.20.2) — 14 Commits landed, Full-Branch-Review **ship it**. **Wartet auf Manual QA auf Fold 7 + `./release.sh` für v1.20.2.** QA-Flows: Lautsprecher-Echo-Test (5× wiederholen, keine Selbst-Unterbrechung), Kopfhörer-Vergleich, Force-Turn-End (Mic-Tap während Rem spricht), Pause/Play-Animationen, Close-2-Tap, Teleprompter bei langem Reply, User-Chip-Fade beim `thinking`-Übergang.
