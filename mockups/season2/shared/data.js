...
(function (global) {
  ...
  const DATA = {
    ...
    sessions: [
      { id: 't1', name: 'Pinterest Scraper', description: 'Claude fixt fehlschlagende Tests', colorTag: '#e8590c', status: 'running', live: true, cwd: '~/dev/pinterest-scraper', script: claudeScript,
      ...
      { id: 't2', name: 'TMS Server', description: 'Live-Logs des Terminal-Servers', colorTag: '#1971c2', status: 'idle', live: false, cwd: '~/Desktop/tms-terminal',
      ...
      { id: 't3', name: 'Deploy Watch', description: 'Vercel Deployment beobachten', colorTag: '#2f9e44', status: 'done', live: false, cwd: '~/Desktop/tms-landing',
      ...
      { id: 't4', name: 'Scratchpad', description: 'Freies Terminal', colorTag: '#9c36b5', status: 'waiting', live: false, cwd: '~',
